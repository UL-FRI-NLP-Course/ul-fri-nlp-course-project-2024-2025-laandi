...
def fetch_core_papers(query: str, max_papers: int = 5):
    ...
    CORE_API_KEY = os.getenv("CORE_API_KEY")  # Make sure to add this to your .env file
...
if __name__ == "__main__":
    ...
    display_markdown(answer_question(question, llm_chain), raw=True)# Import dependencies
import arxiv
import torch
from transformers import AutoTokenizer, AutoModelForCausalLM, pipeline, BitsAndBytesConfig, AutoConfig
from langchain.llms import HuggingFacePipeline
